...
public class TabBuilder {
    public static Component formatPlayerTab(String raw, Player player) {
    ...
    public static Component formatCustomTab(String raw, Player player) {
        ...
        raw = raw.replace("%motd%", GlobalTab.server.getConfiguration().getMotd().toString());
